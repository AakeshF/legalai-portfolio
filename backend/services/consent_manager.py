...
class ConsentManager:
    ...
    def record_consent(
        ...
        consent = ConsentRecord(
            ...
            granted=granted,
            purpose=purpose,
            providers_allowed=json.dumps(providers_allowed) if providers_allowed else None,
            granted_by=user_id,
    ...
    def check_consent(
        ...
        if preferences and not preferences.require_explicit_consent:
            ...
            return {
                "granted": preferences.allow_cloud_processing if consent_type == ConsentType.CLOUD_AI else True,
                "scope": "default",
                "providers_allowed": json.loads(preferences.allowed_providers) if preferences.allowed_providers else None,
        ...
        return [
            {
                ...
                "purpose": c.purpose,
                "providers_allowed": json.loads(c.providers_allowed) if c.providers_allowed else None
            }
            for c in consents
        ]
    ...
    def set_organization_preferences(
        ...
        pref = self.db.query(ConsentPreference).filter_by(
            organization_id=organization_id
        ).first()
    ...
    def get_organization_preferences(
        ...
        return {
            ...
            "allowed_providers": json.loads(pref.allowed_providers) if pref.allowed_providers else [],
    ...
    def get_compliance_report(
        ...
        for consent_type in ConsentType:
            ...
            by_type[consent_type.value] = {
                ...
                "granted": sum(1 for c in type_consents if c.granted and not c.revoked_at),
