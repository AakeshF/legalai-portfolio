...
class MCPManager:
    ...
    def list_servers(self) -> List[Dict[str, Any]]:
        ...
        for server_type, server_class in self.available_servers.items():
            servers.append({
                ...
                "status": "active" if server_type in self.active_servers else "available",
    ...
    async def query_server(self, server_name: str, query: Dict[str, Any]) -> List[Dict[str, Any]]:
...
class FileSystemMCP(BaseMCPServer):
    ...
    async def query(self, query: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if "modified_after" in query:
            ...
            files = [f for f in files if datetime.fromisoformat(f["modified"]) > after_date]
