...
def create_user_tokens(user_id: str, email: str, organization_id: str, role: str) -> Dict[str, str]:
...
async def send_welcome_email(email: str, user_name: str, organization_name: str, temp_password: Optional[str] = None):
