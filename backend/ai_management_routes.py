    ...
    try:
        ...
        for provider in providers:
            ...
            if provider_type in key_status:
                ...
                provider["key_source"] = key_status[provider_type].get("source", "database")
                provider["validation_status"] = key_status[provider_type].get("validation_status")
    ...
    try:
        ...
        for provider in providers:
            ...
            try:
                ...
                key_record = db.query(APIKeyStore).filter_by(
                    organization_id=org.id,
                    provider=provider,
                    is_active=True
                ).first()
