...
class Settings(BaseSettings):
    ...
    disable_auth: bool = Field(default=True, env="DISABLE_AUTH")  # Temporarily hardcoded to True
    ...
    @field_validator("disable_auth", "debug", "demo_mode", "email_enabled", mode="before")
