...
class BackgroundTaskManager:
    ...
    async def _enhance_documents_async(self, document_ids: List[str], organization_id: str):
...
def queue_document_enhancement(document_ids: List[str], organization_id: str):
    ...
    task_manager.add_task("enhance_documents", {
...
def queue_bulk_classification(document_ids: List[str], organization_id: str):
    ...
    task_manager.add_task("bulk_classify", {
        "document_ids": document_ids,
        "organization_id": organization_id
    })
